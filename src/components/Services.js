        ...
        <div id="services" className="bg-gray-100 py-12" >
            <section data-aos="zoom-in-down">
                    <div className="my-4 py-4">
                        <h2 className="my-2 text-center text-3xl text-yellow-500 uppercase font-bold">Blogs</h2>
                        
                        <div className='flex justify-center'>
                            <div className='w-24 border-b-4 border-black'></div>
                        </div>
                        <h2 className="mt-4 mx-12 text-center text-xl lg:text-2xl font-semibold text-black">Check out our latest blogs and new feature we provide.</h2>
                    </div>
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                {/* <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img} /> */}
                                    <h2 className="font-semibold my-4 text-3xl text-center">Access to Authentic Indian Groceries</h2>
                                    <p className="text-md font-medium">
                                    Our app offers a curated selection of Indian grocery stores, ensuring easy access to
                                    authentic ingredients and regional specialties.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                {/* <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img2} /> */}
                                    <h2 className="font-semibold my-4 text-3xl text-center">Real-Time Price Comparison</h2>
                                    <p className="text-md font-medium">
                                    Compare prices and availability of products across multiple stores in real-time,
                                    helping you make informed and budget-friendly choices.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                <div className="m-2 text-justify text-sm">
                                    ...
                                    <h2 className="font-semibold my-4 text-3xl text-center ">Convenient Home Delivery</h2>
                                    <p className="text-md font-medium">
                                    Skip the hassle of traveling to stores. Order groceries through the app and have them
                            ...
                            <div className="bg-white transition-all ease-in-out duration-400  overflow-hidden text-gray-700 hover:bg-gray-500 hover:text-white rounded-lg shadow-2xl p-3 group">
                                ...
                                {/* <img alt="card img" className="rounded-t group-hover:scale-[1.15] transition duration-1000 ease-in-out" src={img4} /> */}
                                    <h2 className="font-semibold my-4 text-3xl text-center ">One-Stop Shopping Experience</h2>
                                    <p className="text-md font-medium">
                                    Browse, compare, and purchase all your grocery needs from multiple vendors on a
                                        single platform, making shopping seamless and efficient.
                                    </p>
                                </div>
                            </div>                    
                        </div>
